...
async fn main(spawner: Spawner) {
    ...
    // MOI
    let moi_0 = ExtiInput::new(p.PA10, p.EXTI10, ylab::Pull::Down);
    let moi_1 = ExtiInput::new(p.PB3, p.EXTI3, ylab::Pull::Down);
    let moi_3 = ExtiInput::new(p.PD0, p.EXTI0, ylab::Pull::Down);
    let moi_4 = ExtiInput::new(p.PD1, p.EXTI1, ylab::Pull::Down);

    spawner
        .spawn(task::moi_task(moi_0, moi_1, moi_3, moi_4))
        .unwrap();
